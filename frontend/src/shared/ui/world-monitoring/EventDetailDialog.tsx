...
import type {
  ...
  Location,
  StructuredField,
} from "../../model/world-monitoring/types";
...
function ArticleMetadataChips({ article }: ArticleMetadataChipsProps) {
  const locations = (article.locations ?? []).slice(0, 4);
            ...
            <Stack spacing={2.5}>
              ...
              {eventDetail.linkedArticlePreview && (
                <Box>
                  ...
                  >
                    {getArticleImage(eventDetail.linkedArticlePreview) && (
                      <CardMedia
                        component="img"
                        image={
                          getArticleImage(
              ...
              {articleDetail && (
                <Box>
                  ...
                  >
                    {getArticleImage(articleDetail) && (
                      <CardMedia
                        component="img"
                        image={getArticleImage(articleDetail) as string}
