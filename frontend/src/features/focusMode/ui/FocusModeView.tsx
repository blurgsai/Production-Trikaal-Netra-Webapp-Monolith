...
import {
  Box, Typography, Paper, Alert, Snackbar, Stack, Chip, Button,
} from '@mui/material'
import {
...
export const FocusModeView = ({
  ...
  <LocalizationProvider dateAdapter={AdapterDayjs}>
    <Box sx={{ p: 2, height: 'calc(100vh - 64px)', display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      {/* Search form — shown when no vessel selected */}
      {!isLoaded && (
      ...
      {/* Map + playback — shown when vessel is loaded */}
      {isLoaded && (
